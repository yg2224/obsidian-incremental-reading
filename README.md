...
- ✨ **国际化支持**：完整的中英文切换系统，动态切换无需重启
- 📈 **优先级可视化**：交互式散点图展示文档优先级分布
- 🎨 **Arctic 主题 UI**：紫色渐变玻璃拟态设计，视觉体验全面升级
- ➖ **移出漫游功能**：智能按钮切换，方便管理漫游列表
- 🐛 **Bug 修复**：修复访问计数重复、相似度计算等多个问题
- ⚡ **性能优化**：防抖机制、缓存优化，界面更加流畅
